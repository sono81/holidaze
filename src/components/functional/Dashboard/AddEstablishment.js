      ...
      >
        <div className="message__item--left">
          ...
          <input
            ...
            className="message__item--input"
          />
          <label htmlFor="id" className="message__item--label">
            ID
          </label>
          <input
            type="number"
        ...
        <div className="message__item--right">
          <p>
            <label htmlFor="selfCatering" className="message__item--radiovalue">
              Self Catering:
            </label>
            <label htmlFor="true" className="message__item--radiovalue">
              {" "}
              Yes
            </label>
            <input type="radio" name="selfCatering" value="true" />
            <label htmlFor="false" className="message__item--radiovalue">
              No
            </label>
            <input type="radio" name="selfCatering" value="false" />
          </p>

          <label htmlFor="price" className="message__item--label">
            Price:
          </label>
          <input type="number" name="price" className="message__item--input" />
          <label htmlFor="maxGuests" className="message__item--label">
            Max Guests:
          </label>
          <input
            type="number"
            ...
            className="message__item--input"
          />
          <label htmlFor="imageUrl" className="message__item--label">
            Image Url:
          </label>
          <input type="text" name="imageUrl" className="message__item--input" />
        </div>
        <label htmlFor="descriprion" className="message__item--label">
          Description:
        </label>
        <textarea
          name="description"
          className="message__item--textarea"
        ></textarea>
