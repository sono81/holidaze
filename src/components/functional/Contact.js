  ...
  return (
    <div className="message__wrap message__wrap--contact">
      ...
      <form method="POST" action={POST_MESSAGES} className="message__item">
        <fieldset>
          <label htmlFor="clientName" className="message__item--label">Full Name:</label>
          <input type="text" name="clientName" className="message__item--input"></input>
          <label htmlFor="email" className="message__item--label">Email:</label>
          <input type="email" name="email" className="message__item--input"></input>
        </fieldset>
        <fieldset>
            <label htmlFor="message" className="message__item--label">Message</label>
